 ...
 * @author WAZA
 */
public class OutputProperties implements Output
{
	final public String path;
	final public String root;
	final public String file_name;
	
	Hashtable<String, ImagesSet>		ImgTable;
	Hashtable<String, SpriteSet>		SprTable;
	Hashtable<String, MapSet>			MapTable;
	Hashtable<String, WorldSet>			WorldTable;
	Hashtable<String, TableSet>			TableGroups;
	
	public OutputProperties(String file) throws Exception
	{
		file = file.replace('\\', '/');
		this.path			= file;
		this.root 			= file.substring(0, file.lastIndexOf("/")+1);
		this.file_name		= file.substring(root.length());

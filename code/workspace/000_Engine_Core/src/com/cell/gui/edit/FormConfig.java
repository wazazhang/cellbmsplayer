...
import com.cell.gui.CheckBox;
import com.cell.gui.Command;
import com.cell.gui.Control;
import com.cell.gui.DropDownSelect;
import com.cell.gui.Form;
import com.cell.gui.FormListener;
import com.cell.gui.GroupPageSelect;
import com.cell.gui.Guage;
import com.cell.gui.Item;
import com.cell.gui.ItemListener;
import com.cell.gui.LabelBar;
import com.cell.gui.RichTextBox;
import com.cell.gui.TextBox;
import com.cell.gui.TextBoxSingle;
			...
			if (node.getNodeName().equals("group"))
			{
				try
				{
					...
					if (type.equals("com.cell.gui.GroupPageSelect")) 
					{
						...
						com.cell.gui.GroupPageSelect group = new GroupPageSelect(form, x, y, w, h);

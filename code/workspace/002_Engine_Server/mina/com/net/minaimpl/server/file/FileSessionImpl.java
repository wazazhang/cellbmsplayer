...
public class FileSessionImpl implements TelnetSession 
{
	final protected IoSession 			Session;
	final protected TelnetServerImpl	Server;
	TelnetSessionListener				Listener;
	
	FileSessionImpl(IoSession session, TelnetServerImpl server){
		Session = session;
		Server = server;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof FileSessionImpl) {
			return Session.equals(((FileSessionImpl) obj).Session);
		}
		return false;
	}

package com.fc.castle.data.message.Messages
{
	...
	/**
	 * 获取玩家任务数据<br>
	 * Java Class [48] [com.fc.castle.data.message.Messages.GetPlayerQuestResponse]<br>
	 * 此代码为自动生成。不需要在此修改。若有错误，请修改代码生成器。
	 */
	[Bindable] 
	public  class GetPlayerQuestResponse extends com.fc.castle.data.message.Response implements MutualMessage
	{
		...
		public function GetPlayerQuestResponse(
			result : int = 0,
